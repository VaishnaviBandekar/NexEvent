...
# Define the function to generate an event theme description
# def generate_event_theme(event_type, audience, season, colors, venue, style):
#     prompt = (
#         f" create a captivating theme description for a {event_type},Set in the {season} season, the theme features the colors {', '.join(colors)},The venue is a {venue}, and the audience is {audience},Convey a {style} vibe and describe how the colors and venue decor will come together to create an unforgettable atmosphere."
#     )
